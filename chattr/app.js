...
// database
var sequelize = new Sequelize('database_development', process.env.DB_USERNAME, process.env.DB_PASSWORD, {
	host: process.env.DB_HOST || 6379,
	port: process.env.DB_PORT || '127.0.0.0'
});
